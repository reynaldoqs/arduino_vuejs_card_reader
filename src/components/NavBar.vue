    ...
    <nav class="flex items-center justify-between bg-gray-900 p-4 shadow-md">
        ...
        <div>
            ...
            <div v-if="user" class="flex items-center">
                ...
                <a @click="logout" class="inline-block text-sm px-4 py-2 leading-none border cursor-pointer rounded-full text-gray-200 border-gray-200 mt-4 lg:mt-0 hover:text-gray-900 hover:border-gray-900 hover:bg-gray-700">Salir</a>
            </div>
            <div v-else class="flex items-center">
                <router-link tag="a" to="/signin" class="inline-block text-sm px-4 py-2 leading-none border rounded-full text-gray-200 border-gray-200 mt-4 lg:mt-0">Ingresar</router-link>
            </div>
        </div>
    </nav>
</template>
